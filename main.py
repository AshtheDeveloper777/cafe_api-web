...
def patch_new_price(cafe_id):
    ...
    cafe = db.session.get(Cafe, cafe_id)  # Returns None if not found
...
def put_update_cafe(cafe_id):
    ...
    cafe.img_url = data.get("img_url", cafe.img_url)
    ...
    cafe.has_wifi = data.get("has_wifi", cafe.has_wifi)
    cafe.has_sockets = data.get("has_sockets", cafe.has_sockets)
    cafe.can_take_calls = data.get("can_take_calls", cafe.can_take_calls)
